...
if menu == "📂 Dataset":
    ...
    st.write("### Visualisasi Evaluasi Metrik untuk Setiap Percobaan")
    ...
    for i in range(len(formatted_results)):
        ...
        ax.bar(labels, metrics, color=colors, alpha=0.7)
        ax.set_title(f"Percobaan {i+1}: Evaluasi Metrik Skenario 1")
    ...
    for i in range(len(formatted_results)):
        ...
        ax.bar(labels, metrics, color=colors, alpha=0.7)
        ax.set_title(f"Percobaan {i+1}: Evaluasi Metrik Skenario 2")
        ax.set_xlabel("Metrik Evaluasi")
        ax.set_ylabel("Nilai (%)")
        ax.set_ylim(0, 100)
        ax.grid(axis='y', linestyle='--', alpha=0.7)
    ...
    for i in range(len(formatted_results)):
        ...
        ax.bar(labels, metrics, color=colors, alpha=0.7)
        ax.set_title(f"Percobaan {i+1}: Evaluasi Metrik Skenario 3")
        ax.set_xlabel("Metrik Evaluasi")
        ax.set_ylabel("Nilai (%)")
        ax.set_ylim(0, 100)
        ax.grid(axis='y', linestyle='--', alpha=0.7)
